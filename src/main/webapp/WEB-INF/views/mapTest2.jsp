...
<body>
			...
			<div class="option">
				<div>
					<form onsubmit="searchPlaces(); return false;">
						키워드 : <input type="text" value="신촌 돈가스" id="keyword" size="15">
	...
	<script>
		...
		// 마커를 생성합니다
		var basicMarker = new daum.maps.Marker({
		...
		(function(basicMarker, title) {
			daum.maps.event.addListener(
					basicMarker
					, 'click'
					, function() {
						displayInfowindow(basicMarker, title);
					});
		})(basicMarker, "쌍용강북교육센터");
